Questions = [
    ...
    {
        "question": "Whuttiff __name__ were a kitchen appliance, which would they be?",
        "options": [
            {"text": "Dishwasher"},
            {"text": "Toaser"},
            {"text": "Fridge"},
    ...
    {
        "question": "Whuttiff __name__ were a type of theme park ride?",
        "options": [
            {"text": "Water Slide"},
            {"text": "Kiddie Pool"},
            {"text": "Biggest Fastest Ride"},
            {"text": "The Vortex"},
            {"text": "Frogger"},
            {"text": "Ferris Wheel"},
            {"text": "Bumper Cars"},
    ...
    {
        "question": "Whuttiff __name__ were a fair food?",
        "options": [
            {"text": "Elephant Ear"},
            {"text": "Pretzel w/ Cheese"},
            {"text": "Fried Oreos"},
    ...
    },
    {
        ...
        "options": [
            ...
            {"text": "Bikini-clad"},
            {"text": "Sporting pose"},
            {"text": "Seated, formally dressed"},
            {"text": "Cover of The Enquirer"}
        ]
    },
    {
